    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
      ...
      >
        ...
        <div className="w-full">
          <button className="bg-primary hover:bg-primary/90 inline-block cursor-pointer rounded-md px-7 py-3 text-center text-base font-medium text-white transition duration-300">
            Purchase Now
          </button>
        </div>
      </div>

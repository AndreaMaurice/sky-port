            ...
            <div className="ud-contact-content-wrapper">
              ...
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div className="mb-8 flex w-[330px] max-w-full">
                  <div className="text-primary mr-6 text-[32px]">
                    <svg
                      width="29"
                      height="35"
                      viewBox="0 0 29 35"
                  ...
                  <div>
                    <h3 className="text-dark mb-[18px] text-lg font-semibold dark:text-white">
                      Our Location
                    </h3>
                ...
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="text-body-color dark:text-dark-6 mt-1 text-base">
            ...
            >
              ...
              <form>
                <div className="mb-[22px]">
                  <label
                    htmlFor="fullName"
                    className="text-body-color dark:text-dark-6 mb-4 block text-sm"
                  >
                    Full Name*
                  </label>
                  <input
                ...
                <div className="mb-0">
                  <button
                    type="submit"
                    className="bg-primary hover:bg-primary/90 inline-flex items-center justify-center rounded-md px-10 py-3 text-base font-medium text-white transition duration-300 ease-in-out"
                  >
                    Send
                  </button>
                </div>

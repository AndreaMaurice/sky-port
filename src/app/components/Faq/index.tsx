    ...
    <section className="dark:bg-dark relative z-20 overflow-hidden bg-white pt-20 pb-8 lg:pt-[120px] lg:pb-[50px]">
      <div className="container">
        <SectionTitle
          subtitle="FAQ"
          title="Any Questions?"
          paragraph="We have compiled answers to some of the most frequently asked questions about our web development services. If you have any other queries, feel free to reach out!"
          width="640px"
          center
        />
